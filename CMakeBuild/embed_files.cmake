...
set(chunks \"\")
set(pos 0)
while(pos LESS content_length)
    math(EXPR end_pos \"\${pos} + \${chunk_size}\")
    if(end_pos GREATER content_length)
        set(end_pos \${content_length})
    endif()
    math(EXPR chunk_length \"\${end_pos} - \${pos}\")
    string(SUBSTRING \"\${file_content}\" \${pos} \${chunk_length} chunk)
    if(chunks STREQUAL \"\")
        set(chunks \"\\\"\${chunk}\\\"\")
    else()
...
file(APPEND \"${EMBED_OUTPUT_HEADER}\" \"    {\\\"${EMBED_PATH_PREFIX}${rel_key}\\\", \\n        \${chunks}}${has_comma}\\n\")
")
        math(EXPR idx "${idx} + 1")
    endforeach()
