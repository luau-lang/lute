...
def generateStdLibFiles():
    ...
    with open("generated/include/lutestdlib.h", "w") as header:
        header.writelines([
            ...
            "};\n",
            "\n",
            "StdLibModuleResult getStdLibModule(std::string_view pathRelativeToStd);\n",
        ])

    with open("generated/src/lutestdlib.cpp", "w") as cpp:
        cpp.writelines([
            "// This file is auto-generated by luthier.py. Do not edit.\n",
            "#include \"lutestdlib.h\"\n",
            "\n",
            "#include <string_view>\n",
            "#include <utility>\n",
            "\n",
            "static constexpr std::pair<std::string_view, std::string_view> lutestdlib[] = {\n",
        ])
    ...
    for dirpath, dirnames, filenames in os.walk("."):
        for dirname in dirnames:
            ...
            with open("generated/src/lutestdlib.cpp", "a") as cpp:
                cpp.write("\n    {\"" + path + "\", \"#directory\"},\n")
    ...
    with open("generated/src/lutestdlib.cpp", "a") as cpp:
        cpp.writelines([
            "};\n",
            "\n",
            "StdLibModuleResult getStdLibContents(std::string_view pathRelativeToStd)\n",
            "{\n",
            "    for (const auto& [path, contents] : lutestdlib)\n",
            "    {\n",
