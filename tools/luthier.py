...
def generateStdLibFiles():
    ...
    with open("generated/include/lutestdlib.h", "w") as header:
        header.writelines([
            ...
            "#include <string>\n",
            "std::string getStdLibContents(std::string pathRelativeToStd);\n",
        ])
    ...
    with open("generated/src/lutestdlib.cpp", "w") as cpp:
        cpp.writelines([
            ...
            "\n",
            "static std::unordered_map<std::string, std::string> lutestdlib;\n",
    ...
    with open("generated/src/lutestdlib.cpp", "a") as cpp:
        cpp.writelines([
            ...
            "        populate();\n",
            "\n",
            "    return lutestdlib[std::move(pathRelativeToStd)];\n",
            "}\n",
        ])
