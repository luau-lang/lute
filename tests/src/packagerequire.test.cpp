...
TEST_CASE_FIXTURE(LuteFixture, "pkgrun_uses_registry_lockfile_identity_and_root_alias")
{
    std::string entry = getLuteProjectRootAbsolute() + "/tests/src/packages/pkgrun_registry_identity/packageentry/entry.luau";
