...
struct TypeSerialize : public Luau::TypeVisitor
{
    ...
    explicit TypeSerialize(lua_State* L)
        : Luau::TypeVisitor("TypeSerialize", /* skipBoundTypes */ true)
        , L(L)
    {
    }
...
int typeofmodule_luau(lua_State* L)
{
    ...
    // Serialize the module's return type directly to table structure
    TypeSerialize serializer{L};
    serializer.traverse(modulePtr->returnType);
